// ==========================================================================
// Papercube.PapersPerYearController
//
...
/** @class
  ...
  This controller is used to control the papers per year view.
  ...
  @static
*/
Papercube.papersPerYearController = SC.Object.create(
/** @scope Papercube.papersPerYearController */ {
  ...
  */
  ...
  /**
    Hide bogus years. If true, no papers with false years will be shown. 
    
    @property {Boolean}
    @default false
  */
  hideBogusYears: false,
  ...
  */
  ...
  /**
    Increment cite ref strength towards the minimum.
  */
